...
DATA.DIR <- "C:\\Users\\friederike.ehrhart\\Documents\\R\\R Projects\\affyQC_Module oligo version AD\\AD_rawdata"
SCRIPT.DIR <- "C:\\Users\\friederike.ehrhart\\Documents\\R\\R Projects\\affyQC_Module oligo version AD"
...
WORK.DIR <- "C:\\Users\\friederike.ehrhart\\Documents\\R\\R Projects\\affyQC_Module oligo version AD\\Results"
...
prefOligo <- TRUE
arrayGroup <- "C:\\Users\\friederike.ehrhart\\Documents\\R\\R Projects\\affyQC_Module oligo version AD\\DescriptionAD.txt" #see comments below
reOrder <- TRUE
layoutPlot <- TRUE
controlPlot <- TRUE
samplePrep <- TRUE
...
clusterRaw <- TRUE
clusterNorm <- TRUE
clusterOption1 <- "Pearson" #see comments below
...
customCDF <- FALSE  #only for affy package
CDFtype <- "ENSG" #see comments below
species <- "Hs" #see comments below
